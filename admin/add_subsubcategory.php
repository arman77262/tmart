...
if (isset($_POST['add_cat'])){
    ...
    $insertCat = $ct->subsubCatInsert($rootcatName, $subcatName, $catName);
}
?>
    <!-- CONTENT -->
    <!-- ========================================================= -->
                    ...
                    <div class="col-md-12">
                        <form action="" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <select name="sub_cat" class="form-control" id="">
                                    ...
                                    if ($allcat){
                                        while ($row = mysqli_fetch_assoc($allcat)){
                                            ?>
                                            <option value="<?=$row['scatId']?>"><?=$row['subCatName']?></option>
                                            <?php
                                        }
                                    }
                                    ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="catName" id="email" placeholder="Sub SubCategory">
                            </div>
                            <div class="form-group">
